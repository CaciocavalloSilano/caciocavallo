...
OUTPUT_PATH=dist/Release/${PLATFORM}/libnative.so
...
# Generate tar file
cd "${TOP}"
rm -f dist/Release/${PLATFORM}/package/libnative.so.tar
cd ${TMPDIR}
tar -vcf ../../../../dist/Release/${PLATFORM}/package/libnative.so.tar *
checkReturnCode
